...
func (x *GreetManyTimesRequest) Reset() {
	*x = GreetManyTimesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greet_greetpb_greetpb_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greetpb_proto_rawDescGZIP(), []int{3}
}
...
func (x *GreetManyTimesResponse) Reset() {
	*x = GreetManyTimesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greet_greetpb_greetpb_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetManyTimesResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greetpb_proto_rawDescGZIP(), []int{4}
}
...
var file_greet_greetpb_greetpb_proto_rawDesc = []byte{
	...
	0x22, 0x00, 0x30, 0x01, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2f,
...
var file_greet_greetpb_greetpb_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
func file_greet_greetpb_greetpb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greetpb_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_greet_greetpb_greetpb_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
